    ...
    switch(args[0].toLowerCase()) {
      case "weapon":
        ...
        switch(args[1].toLowerCase()) {
          ...
          case "pvp-damage": return (100-WeaponStats.getTotalPvPDamage()).toFixed(1);
          // Sát thương gia tăng - PvE: %javascript_mystats_weapon,pve-damage%
          case "pve-damage": return (100-WeaponStats.getTotalPvEDamage()).toFixed(1);
          ...
          case "hit-rate": return (100-WeaponStats.getTotalHitRate()).toFixed(1);
      ...
      case "armor":
        ...
        switch(args[1].toLowerCase()) {
          ...
          case "pvp-defense": return (100-ArmorStats.getTotalPvPDefense()).toFixed(1);
          // Sức thủ gia tăng - PvE: %javascript_mystats_armor_pve-defense%
          case "pve-defense": return (100-ArmorStats.getTotalPvEDefense()).toFixed(1);
